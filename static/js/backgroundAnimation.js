...
var gradCanvas = document.getElementById('bgCanvas');
// let container = document.getElementById("bgCont");
// var gradCanvas = container.createElement('canvas');
console.log(gradCanvas)
console.log("STUFF");
